                        ...
                        <>
                            {providers && 
                                Object.values(providers).map((provider)=>(
                                    <button className="black_button" type="button" key={provider.name} onClick={()=>signIn(provider.id)}>
                                        Sing In
                                    </button>
                                ))
                            }
            ...
            <div className="sm:hidden flex relative">
                {
                    session?.user ? (
                        <div className="flex">
                            <Image className="rounded-full" onClick={()=>setToggleDropdown((prev)=>!prev)} src="/assets/images/logo.svg" width={37} height={37} alt="profile" />
                            {toggleDropdown && (
